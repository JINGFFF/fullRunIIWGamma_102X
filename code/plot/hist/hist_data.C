...
void hist_data(){
        ...
        TFile * input = TFile::Open("/home/pku/pengj/VBSWGamma/94X2016/myplot/plotdata/mu.root");
        TFile* output = new TFile("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/hist_data_mu.root","RECREATE");
	...
	while (fReader.Next()){
		...
		if (fabs(*photonsceta) < 1.4442){
			barrel_nVtx->Fill(*nVtx);
			barrel_ptlep1->Fill(*ptlep1);
			barrel_etalep1->Fill(*etalep1);
			barrel_mtVlepJECnew->Fill(*mtVlepJECnew);
			barrel_ptVlepJEC->Fill(*ptVlepJEC);
			barrel_photonet->Fill(*photonet);
			barrel_photoneta->Fill(*photoneta);
			barrel_photonsceta->Fill(*photonsceta);
			barrel_jet1pt->Fill(*jet1pt);
			barrel_jet1eta->Fill(*jet1eta);
                        barrel_jet2pt->Fill(*jet2pt);
                        barrel_jet2eta->Fill(*jet2eta);
			barrel_Mjj->Fill(*Mjj);
			barrel_zepp->Fill(*zepp);
			barrel_deltaeta->Fill(*deltaeta);
			barrel_MET_et->Fill(*MET_et);
			barrel_Dphiwajj->Fill(*Dphiwajj);
			barrel_Mla->Fill(*Mla);
                ...
                if (fabs(*photonsceta) > 1.566 && fabs(*photonsceta) < 2.5){
                        endcap_nVtx->Fill(*nVtx);
                        endcap_ptlep1->Fill(*ptlep1);
                        endcap_etalep1->Fill(*etalep1);
                        endcap_mtVlepJECnew->Fill(*mtVlepJECnew);
                        endcap_ptVlepJEC->Fill(*ptVlepJEC);
                        endcap_photonet->Fill(*photonet);
                        endcap_photoneta->Fill(*photoneta);
                        endcap_photonsceta->Fill(*photonsceta);
                        endcap_jet1pt->Fill(*jet1pt);
                        endcap_jet1eta->Fill(*jet1eta);
                        endcap_jet2pt->Fill(*jet2pt);
                        endcap_jet2eta->Fill(*jet2eta);
                        endcap_Mjj->Fill(*Mjj);
                        endcap_zepp->Fill(*zepp);
                        endcap_deltaeta->Fill(*deltaeta);
                        endcap_MET_et->Fill(*MET_et);
                        endcap_Dphiwajj->Fill(*Dphiwajj);
                        endcap_Mla->Fill(*Mla);
	...
	cb2->cd();
        ...
        cb1->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_nVtx.png");
        cb2->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_ptlep1.png");
        cb3->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_etalep1.png");
        cb4->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_mtVlepJECnew.png");
        cb5->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_ptVlepJEC.png");
        cb6->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_photonet.png");
        cb7->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_photoneta.png");
        cb8->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_photonsceta.png");
        cb9->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_jet1pt.png");
        cb10->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_jet1eta.png");
        cb11->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_jet2pt.png");
        cb12->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_jet2eta.png");
        cb13->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_Mjj.png");
        cb14->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_zepp.png");
        cb15->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_deltaeta.png");
        cb16->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_MET_et.png");
        cb17->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_Dphiwajj.png");
        cb18->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_barrel_Mla.png");

        ce1->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_nVtx.png");
        ce2->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_ptlep1.png");
        ce3->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_etalep1.png");
        ce4->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_mtVlepJECnew.png");
        ce5->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_ptVlepJEC.png");
        ce6->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_photonet.png");
        ce7->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_photoneta.png");
        ce8->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_photonsceta.png");
        ce9->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_jet1pt.png");
        ce10->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_jet1eta.png");
        ce11->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_jet2pt.png");
        ce12->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_jet2eta.png");
        ce13->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_Mjj.png");
        ce14->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_zepp.png");
        ce15->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_deltaeta.png");
        ce16->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_MET_et.png");
        ce17->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_Dphiwajj.png");
        ce18->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/png/data_endcap_Mla.png");
