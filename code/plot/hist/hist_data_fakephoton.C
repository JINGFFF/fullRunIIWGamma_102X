...
void hist_data_fakephoton(){
	...
	double fake_lepton_weight, barrel_fake_photonweight, endcap_fake_photonweight, weight;

        TFile * input = TFile::Open("/home/pku/pengj/VBSWGamma/94X2016/myplot/plotdata/fakephoton_mu.root");
        TFile* output = new TFile("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/hist_store/hist_data_fakephoton_mu.root","RECREATE");

	//fake lepton weight
	//TFile * frw = TFile::Open("/home/pku/pengj/VBSWGamma/2016/myplot/plotdata/fake_muon.root");
	//TH2D* h = (TH2D*)frw->Get("weight");
	//fake photon weight
        TFile * fprw = TFile::Open("/home/pku/pengj/VBSWGamma/94X2016/myplot/plotdata/fake_photon_weight.root");
        TH1F* b = (TH1F*)fprw->Get("muon_barrel_fake_photon_weight");
        TH1F* e = (TH1F*)fprw->Get("muon_endcap_fake_photon_weight");
	...
	while (fReader.Next()){
		...
		i++;
	  	...
	  	//if (i>100) break;
                ...
                //&& *drla>0.5 && *drj1l>0.5 && *drj2l_f>0.5 && *drj1a_f>0.5 && *drj2a_f>0.5
		...
		barrel_fake_photonweight = b->GetBinContent(b->GetXaxis()->FindBin(*photonet_f));
                endcap_fake_photonweight = e->GetBinContent(b->GetXaxis()->FindBin(*photonet_f));
		
		//barell hist fill
		if (fabs(*photonsceta_f) < 1.4442){
			weight = barrel_fake_photonweight;	
//cout<<weight<<endl;	
			...
			barrel_photonet->Fill(*photonet_f,weight);
			barrel_photoneta->Fill(*photoneta_f,weight);
			barrel_photonsceta->Fill(*photonsceta_f,weight);
			...
			barrel_Dphiwajj->Fill(*Dphiwajj_f,weight);
			barrel_Mla->Fill(*Mla_f,weight);

		}

                //endcap hist fill
                if (fabs(*photonsceta_f) > 1.566 && fabs(*photonsceta_f) < 2.5){
			weight = endcap_fake_photonweight;
                        ...
                        endcap_photonet->Fill(*photonet_f,weight);
                        endcap_photoneta->Fill(*photoneta_f,weight);
                        endcap_photonsceta->Fill(*photonsceta_f,weight);
                        ...
                        endcap_Dphiwajj->Fill(*Dphiwajj_f,weight);
                        endcap_Mla->Fill(*Mla_f,weight);
	...
	cb2->cd();
        ...
        cb1->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_nVtx.png");
        cb2->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_ptlep1.png");
        cb3->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_etalep1.png");
        cb4->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_mtVlepJECnew.png");
        cb5->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_ptVlepJEC.png");
        cb6->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_photonet.png");
        cb7->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_photoneta.png");
        cb8->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_photonsceta.png");
        cb9->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_jet1pt.png");
        cb10->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_jet1eta.png");
        cb11->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_jet2pt.png");
        cb12->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_jet2eta.png");
        cb13->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_Mjj.png");
        cb14->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_zepp.png");
        cb15->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_deltaeta.png");
        cb16->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_MET_et.png");
        cb17->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_Dphiwajj.png");
        cb18->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonbarrel_Mla.png");

        ce1->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_nVtx.png");
        ce2->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_ptlep1.png");
        ce3->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_etalep1.png");
        ce4->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_mtVlepJECnew.png");
        ce5->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_ptVlepJEC.png");
        ce6->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_photonet.png");
        ce7->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_photoneta.png");
        ce8->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_photonsceta.png");
        ce9->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_jet1pt.png");
        ce10->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_jet1eta.png");
        ce11->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_jet2pt.png");
        ce12->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_jet2eta.png");
        ce13->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_Mjj.png");
        ce14->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_zepp.png");
        ce15->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_deltaeta.png");
        ce16->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_MET_et.png");
        ce17->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_Dphiwajj.png");
        ce18->SaveAs("/home/pku/pengj/VBSWGamma/94X2016/myplot/make_hist/his_tore/png/data_fakephotonendcap_Mla.png");
