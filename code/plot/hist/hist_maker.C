...
using namespace std;
void hist_mc(TString sample,TString workdir,TString hist_store_png,TString hist_store){
	
	double weight, lumi = 35.857;	

        TFile * input = TFile::Open(workdir + "plotdata/" + sample + ".root");
        TFile* output = new TFile(workdir + hist_store + "/hist_" + sample + ".root","RECREATE");
	...
	while (fReader.Next()){
		...
		&& *photonhaspixelseed<1 && *photonet>25. && *photonet < 400. 
		...
		*/
		weight = (*scalef) * lumi * (*pileupWeight);
		//barell hist fill
	...
	cb2->cd();
        ...
        cb1->SaveAs(workdir + hist_store_png + sample + "_barrel_nVtx.png");
        cb2->SaveAs(workdir + hist_store_png  + sample + "_barrel_ptlep1.png");
        cb3->SaveAs(workdir + hist_store_png  + sample + "_barrel_etalep1.png");
        cb4->SaveAs(workdir + hist_store_png  + sample + "_barrel_mtVlepJECnew.png");
        cb5->SaveAs(workdir + hist_store_png  + sample + "_barrel_ptVlepJEC.png");
        cb6->SaveAs(workdir + hist_store_png  + sample + "_barrel_photonet.png");
        cb7->SaveAs(workdir + hist_store_png  + sample + "_barrel_photoneta.png");
        cb8->SaveAs(workdir + hist_store_png  + sample + "_barrel_photonsceta.png");
        cb9->SaveAs(workdir + hist_store_png  + sample + "_barrel_jet1pt.png");
        cb10->SaveAs(workdir + hist_store_png  + sample + "_barrel_jet1eta.png");
        cb11->SaveAs(workdir + hist_store_png  + sample + "_barrel_jet2pt.png");
        cb12->SaveAs(workdir + hist_store_png  + sample + "_barrel_jet2eta.png");
        cb13->SaveAs(workdir + hist_store_png  + sample + "_barrel_Mjj.png");
        cb14->SaveAs(workdir + hist_store_png  + sample + "_barrel_zepp.png");
        cb15->SaveAs(workdir + hist_store_png  + sample + "_barrel_deltaeta.png");
        cb16->SaveAs(workdir + hist_store_png  + sample + "_barrel_MET_et.png");
        cb17->SaveAs(workdir + hist_store_png  + sample + "_barrel_Dphiwajj.png");
        cb18->SaveAs(workdir + hist_store_png  + sample + "_barrel_Mla.png");

        ce1->SaveAs(workdir + hist_store_png  + sample + "_endcap_nVtx.png");
        ce2->SaveAs(workdir + hist_store_png  + sample + "_endcap_ptlep1.png");
        ce3->SaveAs(workdir + hist_store_png  + sample + "_endcap_etalep1.png");
        ce4->SaveAs(workdir + hist_store_png  + sample + "_endcap_mtVlepJECnew.png");
        ce5->SaveAs(workdir + hist_store_png  + sample + "_endcap_ptVlepJEC.png");
        ce6->SaveAs(workdir + hist_store_png  + sample + "_endcap_photonet.png");
        ce7->SaveAs(workdir + hist_store_png  + sample + "_endcap_photoneta.png");
        ce8->SaveAs(workdir + hist_store_png  + sample + "_endcap_photonsceta.png");
        ce9->SaveAs(workdir + hist_store_png  + sample + "_endcap_jet1pt.png");
        ce10->SaveAs(workdir + hist_store_png  + sample + "_endcap_jet1eta.png");
        ce11->SaveAs(workdir + hist_store_png  + sample + "_endcap_jet2pt.png");
        ce12->SaveAs(workdir + hist_store_png  + sample + "_endcap_jet2eta.png");
        ce13->SaveAs(workdir + hist_store_png  + sample + "_endcap_Mjj.png");
        ce14->SaveAs(workdir + hist_store_png  + sample + "_endcap_zepp.png");
        ce15->SaveAs(workdir + hist_store_png  + sample + "_endcap_deltaeta.png");
        ce16->SaveAs(workdir + hist_store_png  + sample + "_endcap_MET_et.png");
        ce17->SaveAs(workdir + hist_store_png  + sample + "_endcap_Dphiwajj.png");
        ce18->SaveAs(workdir + hist_store_png  + sample + "_endcap_Mla.png");
...
int main(int argc, char** argv) {
    cout << "Start make hist fot MC" << endl;
    TString sample = argv[1];
    TString workdir = "/home/pku/pengj/VBSWGamma/94X2016/myplot/";
    TString hist_store_png = "make_hist/hist_store/png/";
    TString hist_store = "make_hist/hist_store/";
    //mkdir for output
    system("mkdir -p " + workdir + hist_store);
    system("mkdir -p " + workdir + hist_store_png);

    cout << "MC sample name : "<<sample<< endl;
    hist_mc(sample,workdir,hist_store_png,hist_store);
    return 0;
}
