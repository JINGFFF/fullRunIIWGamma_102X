...
void xx::Init(TTree *tree)
{
   ...
   ExTree = new TTree("demo","demo");
    ...
    ExTree->Branch("hasphoton",&hasphoton, "hasphoton/I");
    ExTree->Branch("ngoodmus",&ngoodmus, "ngoodmus/I");
    ExTree->Branch("ngoodeles",&ngoodeles, "ngoodeles/I");
    ExTree->Branch("jet1hf_orig",&jet1hf_orig, "jet1hf_orig/I");
    ExTree->Branch("jet1pf_orig",&jet1pf_orig, "jet1pf_orig/I");
    ExTree->Branch("jet2hf_orig",&jet2hf_orig, "jet2hf_orig/I");
    ExTree->Branch("jet2pf_orig",&jet2pf_orig, "jet2pf_orig/I");
    ExTree->Branch("jet1pt_orig",&jet1pt_orig, "jet1pt_orig/D");
    ExTree->Branch("jet1phi_orig",&jet1phi_orig, "jet1phi_orig/D");
    ExTree->Branch("jet1eta_orig",&jet1eta_orig, "jet1eta_orig/D");
    ExTree->Branch("jet1e_orig",&jet1e_orig, "jet1e_orig/D");
    ExTree->Branch("jet1csv_orig",&jet1csv_orig, "jet1csv_orig/D");
    ExTree->Branch("jet1icsv_orig",&jet1icsv_orig, "jet1icsv_orig/D");
    ExTree->Branch("drj1a_orig",&drj1a_orig, "drj1a_orig/D");
    ExTree->Branch("drj1l_orig",&drj1l_orig, "drj1l_orig/D");
    ExTree->Branch("jet2pt_orig",&jet2pt_orig, "jet2pt_orig/D");
    ExTree->Branch("jet2phi_orig",&jet2phi_orig, "jet2phi_orig/D");
    ExTree->Branch("jet2eta_orig",&jet2eta_orig, "jet2eta_orig/D");
    ExTree->Branch("jet2e_orig",&jet2e_orig, "jet2e_orig/D");
    ExTree->Branch("jet2csv_orig",&jet2csv_orig, "jet2csv_orig/D");
    ExTree->Branch("jet2icsv_orig",&jet2icsv_orig, "jet2icsv_orig/D");
    ExTree->Branch("drj2a_orig",&drj2a_orig, "drj2a_orig/D");
    ExTree->Branch("drj2l_orig",&drj2l_orig, "drj2l_orig/D");
    ExTree->Branch("rawPt",&rawPt, "rawPt/D");
    ...
    ExTree->Branch("photonpasseleveto_F",&photonpasseleveto_F, "photonpasseleveto_F/O");
    ...
    ExTree->Branch("photonsceta_f",&photonsceta_f, "photonsceta_f/D");
    ExTree->Branch("photonscphi",&photonscphi, "photonscphi/D");
    ExTree->Branch("photonscphi_f",&photonscphi_f, "photonscphi_f/D");
    ...
    ExTree->Branch("ak4jet_pt_old",&ak4jet_pt_old, "ak4jet_pt_old[6]/D");
    ExTree->Branch("ak4jet_pt_new",&ak4jet_pt_new, "ak4jet_pt_new[6]/D");
    ExTree->Branch("ak4jet_pt_JEC_up",&ak4jet_pt_JEC_up, "ak4jet_pt_JEC_up[6]/D");
    ExTree->Branch("ak4jet_pt_JEC_down",&ak4jet_pt_JEC_down, "ak4jet_pt_JEC_down[6]/D");
    ExTree->Branch("ak4jet_pt_JER_up",&ak4jet_pt_JER_up, "ak4jet_pt_JER_up[6]/D");
    ExTree->Branch("ak4jet_pt_JER_down",&ak4jet_pt_JER_down, "ak4jet_pt_JER_down[6]/D");
    //ExTree->Branch("ak4jet_eta",&ak4jet_eta, "ak4jet_eta[6]/D");
    //ExTree->Branch("ak4jet_phi",&ak4jet_phi, "ak4jet_phi[6]/D");
    ExTree->Branch("ak4jet_e_old",&ak4jet_e_old, "ak4jet_e_old[6]/D");
    ExTree->Branch("ak4jet_e_new",&ak4jet_e_new, "ak4jet_e_new[6]/D");
    ExTree->Branch("ak4jet_e_JEC_up",&ak4jet_e_JEC_up, "ak4jet_e_JEC_up[6]/D");
    ExTree->Branch("ak4jet_e_JEC_down",&ak4jet_e_JEC_down, "ak4jet_e_JEC_down[6]/D");
    ExTree->Branch("ak4jet_e_JER_up",&ak4jet_e_JER_up, "ak4jet_e_JER_up[6]/D");
    ExTree->Branch("ak4jet_e_JER_down",&ak4jet_e_JER_down, "ak4jet_e_JER_down[6]/D");
    //ExTree->Branch("ak4jet_csv",&ak4jet_csv, "ak4jet_csv[6]/D");
    //ExTree->Branch("ak4jet_icsv",&ak4jet_icsv, "ak4jet_icsv[6]/D");
    ...
    ExTree->Branch("jet1pt_new_f",&jet1pt_new_f, "jet1pt_new_f/D");
    ExTree->Branch("jet1pt_JEC_up_f",&jet1pt_JEC_up_f, "jet1pt_JEC_up_f/D");
    ExTree->Branch("jet1pt_JER_up_f",&jet1pt_JER_up_f, "jet1pt_JER_up_f/D");
    ExTree->Branch("jet1pt_JEC_down_f",&jet1pt_JEC_down_f, "jet1pt_JEC_down_f/D");
    ExTree->Branch("jet1pt_JER_down_f",&jet1pt_JER_down_f, "jet1pt_JER_down_f/D");
    ...
    ExTree->Branch("jet1eta_new_f",&jet1eta_new_f, "jet1eta_new_f/D");
    ExTree->Branch("jet1eta_JEC_up_f",&jet1eta_JEC_up_f, "jet1eta_JEC_up_f/D");
    ExTree->Branch("jet1eta_JEC_down_f",&jet1eta_JEC_down_f, "jet1eta_JEC_down_f/D");
    ExTree->Branch("jet1eta_JER_up_f",&jet1eta_JER_up_f, "jet1eta_JER_up_f/D");
    ExTree->Branch("jet1eta_JER_down_f",&jet1eta_JER_down_f, "jet1eta_JER_down_f/D");
    ...
    ExTree->Branch("jet1phi_new_f",&jet1phi_new_f, "jet1phi_new_f/D");
    ExTree->Branch("jet1phi_JEC_up_f",&jet1phi_JEC_up_f, "jet1phi_JEC_up_f/D");
    ExTree->Branch("jet1phi_JEC_down_f",&jet1phi_JEC_down_f, "jet1phi_JEC_down_f/D");
    ExTree->Branch("jet1phi_JER_up_f",&jet1phi_JER_up_f, "jet1phi_JER_up_f/D");
    ExTree->Branch("jet1phi_JER_down_f",&jet1phi_JER_down_f, "jet1phi_JER_down_f/D");
    ...
    ExTree->Branch("jet1e_new_f",&jet1e_new_f, "jet1e_new_f/D");
    ExTree->Branch("jet1e_JEC_up_f",&jet1e_JEC_up_f, "jet1e_JEC_up_f/D");
    ExTree->Branch("jet1e_JER_up_f",&jet1e_JER_up_f, "jet1e_JER_up_f/D");
    ExTree->Branch("jet1e_JEC_down_f",&jet1e_JEC_down_f, "jet1e_JEC_down_f/D");
    ExTree->Branch("jet1e_JER_down_f",&jet1e_JER_down_f, "jet1e_JER_down_f/D");
    ...
    ExTree->Branch("jet1csv_new_f",&jet1csv_new_f, "jet1csv_new_f/D");
    ExTree->Branch("jet1csv_JEC_up_f",&jet1csv_JEC_up_f, "jet1csv_JEC_up_f/D");
    ExTree->Branch("jet1csv_JER_up_f",&jet1csv_JER_up_f, "jet1csv_JER_up_f/D");
    ExTree->Branch("jet1csv_JEC_down_f",&jet1csv_JEC_down_f, "jet1csv_JEC_down_f/D");
    ExTree->Branch("jet1csv_JER_down_f",&jet1csv_JER_down_f, "jet1csv_JER_down_f/D");
    ...
    ExTree->Branch("jet1icsv_new_f",&jet1icsv_new_f, "jet1icsv_new_f/D");
    ExTree->Branch("jet1icsv_JEC_up_f",&jet1icsv_JEC_up_f, "jet1icsv_JEC_up_f/D");
    ExTree->Branch("jet1icsv_JER_up_f",&jet1icsv_JER_up_f, "jet1icsv_JER_up_f/D");
    ExTree->Branch("jet1icsv_JEC_down_f",&jet1icsv_JEC_down_f, "jet1icsv_JEC_down_f/D");
    ExTree->Branch("jet1icsv_JER_down_f",&jet1icsv_JER_down_f, "jet1icsv_JER_down_f/D");
    ...
    ExTree->Branch("jet2pt_new_f",&jet2pt_new_f, "jet2pt_new_f/D");
    ExTree->Branch("jet2pt_JEC_up_f",&jet2pt_JEC_up_f, "jet2pt_JEC_up_f/D");
    ExTree->Branch("jet2pt_JER_up_f",&jet2pt_JER_up_f, "jet2pt_JER_up_f/D");
    ExTree->Branch("jet2pt_JEC_down_f",&jet2pt_JEC_down_f, "jet2pt_JEC_down_f/D");
    ExTree->Branch("jet2pt_JER_down_f",&jet2pt_JER_down_f, "jet2pt_JER_down_f/D");
    ...
    ExTree->Branch("jet2phi_new_f",&jet2phi_new_f, "jet2phi_new_f/D");
    ExTree->Branch("jet2phi_JEC_up_f",&jet2phi_JEC_up_f, "jet2phi_JEC_up_f/D");
    ExTree->Branch("jet2phi_JEC_down_f",&jet2phi_JEC_down_f, "jet2phi_JEC_down_f/D");
    ExTree->Branch("jet2phi_JER_up_f",&jet2phi_JER_up_f, "jet2phi_JER_up_f/D");
    ExTree->Branch("jet2phi_JER_down_f",&jet2phi_JER_down_f, "jet2phi_JER_down_f/D");
    ExTree->Branch("jet2eta_new_f",&jet2eta_new_f, "jet2eta_new_f/D");
    ExTree->Branch("jet2eta_JEC_up_f",&jet2eta_JEC_up_f, "jet2eta_JEC_up_f/D");
    ExTree->Branch("jet2eta_JEC_down_f",&jet2eta_JEC_down_f, "jet2eta_JEC_down_f/D");
    ExTree->Branch("jet2eta_JER_up_f",&jet2eta_JER_up_f, "jet2eta_JER_up_f/D");
    ExTree->Branch("jet2eta_JER_down_f",&jet2eta_JER_down_f, "jet2eta_JER_down_f/D");
    ...
    ExTree->Branch("jet2e_JER_down",&jet2e_JER_down, "jet2e_JER_down/D");
    ExTree->Branch("jet2e_f",&jet2e_f, "jet2e_f/D");
    ExTree->Branch("jet2e_new_f",&jet2e_new_f, "jet2e_new_f/D");
    ExTree->Branch("jet2e_JEC_up_f",&jet2e_JEC_up_f, "jet2e_JEC_up_f/D");
    ExTree->Branch("jet2e_JER_up_f",&jet2e_JER_up_f, "jet2e_JER_up_f/D");
    ExTree->Branch("jet2e_JEC_down_f",&jet2e_JEC_down_f, "jet2e_JEC_down_f/D");
    ExTree->Branch("jet2e_JER_down_f",&jet2e_JER_down_f, "jet2e_JER_down_f/D");
    ...
    ExTree->Branch("jet2csv_new_f",&jet2csv_new_f, "jet2csv_new_f/D");
    ExTree->Branch("jet2csv_JEC_up_f",&jet2csv_JEC_up_f, "jet2csv_JEC_up_f/D");
    ExTree->Branch("jet2csv_JER_up_f",&jet2csv_JER_up_f, "jet2csv_JER_up_f/D");
    ExTree->Branch("jet2csv_JEC_down_f",&jet2csv_JEC_down_f, "jet2csv_JEC_down_f/D");
    ExTree->Branch("jet2csv_JER_down_f",&jet2csv_JER_down_f, "jet2csv_JER_down_f/D");
    ...
    ExTree->Branch("jet2icsv_new_f",&jet2icsv_new_f, "jet2icsv_new_f/D");
    ExTree->Branch("jet2icsv_JEC_up_f",&jet2icsv_JEC_up_f, "jet2icsv_JEC_up_f/D");
    ExTree->Branch("jet2icsv_JER_up_f",&jet2icsv_JER_up_f, "jet2icsv_JER_up_f/D");
    ExTree->Branch("jet2icsv_JEC_down_f",&jet2icsv_JEC_down_f, "jet2icsv_JEC_down_f/D");
    ExTree->Branch("jet2icsv_JER_down_f",&jet2icsv_JER_down_f, "jet2icsv_JER_down_f/D");
    ...
    ExTree->Branch("drj1a_new_f",&drj1a_new_f, "drj1a_new_f/D");
    ExTree->Branch("drj1a_JEC_up_f",&drj1a_JEC_up_f, "drj1a_JEC_up_f/D");
    ExTree->Branch("drj1a_JEC_down_f",&drj1a_JEC_down_f, "drj1a_JEC_down_f/D");
    ExTree->Branch("drj1a_JER_up_f",&drj1a_JER_up_f, "drj1a_JER_up_f/D");
    ExTree->Branch("drj1a_JER_down_f",&drj1a_JER_down_f, "drj1a_JER_down_f/D");
    ...
    ExTree->Branch("drj2a_new_f",&drj2a_new_f, "drj2a_new_f/D");
    ExTree->Branch("drj2a_JEC_up_f",&drj2a_JEC_up_f, "drj2a_JEC_up_f/D");
    ExTree->Branch("drj2a_JEC_down_f",&drj2a_JEC_down_f, "drj2a_JEC_down_f/D");
    ExTree->Branch("drj2a_JER_up_f",&drj2a_JER_up_f, "drj2a_JER_up_f/D");
    ExTree->Branch("drj2a_JER_down_f",&drj2a_JER_down_f, "drj2a_JER_down_f/D");
    ...
    ExTree->Branch("drj1l_new_f",&drj1l_new_f, "drj1l_new_f/D");
    ExTree->Branch("drj1l_JEC_up_f",&drj1l_JEC_up_f, "drj1l_JEC_up_f/D");
    ExTree->Branch("drj1l_JEC_down_f",&drj1l_JEC_down_f, "drj1l_JEC_down_f/D");
    ExTree->Branch("drj1l_JER_up_f",&drj1l_JER_up_f, "drj1l_JER_up_f/D");
    ExTree->Branch("drj1l_JER_down_f",&drj1l_JER_down_f, "drj1l_JER_down_f/D");
    ...
    ExTree->Branch("drj2l_new_f",&drj2l_new_f, "drj2l_new_f/D");
    ExTree->Branch("drj2l_JEC_up_f",&drj2l_JEC_up_f, "drj2l_JEC_up_f/D");
    ExTree->Branch("drj2l_JEC_down_f",&drj2l_JEC_down_f, "drj2l_JEC_down_f/D");
    ExTree->Branch("drj2l_JER_up_f",&drj2l_JER_up_f, "drj2l_JER_up_f/D");
    ExTree->Branch("drj2l_JER_down_f",&drj2l_JER_down_f, "drj2l_JER_down_f/D");
    ...
    ExTree->Branch("Mjj_new_f",&Mjj_new_f, "Mjj_new_f/D");
    ExTree->Branch("Mjj_JEC_up_f",&Mjj_JEC_up_f, "Mjj_JEC_up_f/D");
    ExTree->Branch("Mjj_JEC_down_f",&Mjj_JEC_down_f, "Mjj_JEC_down_f/D");
    ExTree->Branch("Mjj_JER_up_f",&Mjj_JER_up_f, "Mjj_JER_up_f/D");
    ExTree->Branch("Mjj_JER_down_f",&Mjj_JER_down_f, "Mjj_JER_down_f/D");
    ...
    ExTree->Branch("deltaeta_new_f",&deltaeta_new_f, "deltaeta_new_f/D");
    ExTree->Branch("deltaeta_JEC_up_f",&deltaeta_JEC_up_f, "deltaeta_JEC_up_f/D");
    ExTree->Branch("deltaeta_JEC_down_f",&deltaeta_JEC_down_f, "deltaeta_JEC_down_f/D");
    ExTree->Branch("deltaeta_JER_up_f",&deltaeta_JER_up_f, "deltaeta_JER_up_f/D");
    ExTree->Branch("deltaeta_JER_down_f",&deltaeta_JER_down_f, "deltaeta_JER_down_f/D");
    ...
    ExTree->Branch("zepp_new_f",&zepp_new_f, "zepp_new_f/D");
    ExTree->Branch("zepp_JEC_up_f",&zepp_JEC_up_f, "zepp_JEC_up_f/D");
    ExTree->Branch("zepp_JEC_down_f",&zepp_JEC_down_f, "zepp_JEC_down_f/D");
    ExTree->Branch("zepp_JER_up_f",&zepp_JER_up_f, "zepp_JER_up_f/D");
    ExTree->Branch("zepp_JER_down_f",&zepp_JER_down_f, "zepp_JER_down_f/D");
    ExTree->Branch("ptlep1",&ptlep1, "ptlep1/D");
    ExTree->Branch("etalep1",&etalep1, "etalep1/D");
    ExTree->Branch("philep1",&philep1, "philep1/D");
    ExTree->Branch("energylep1",&energylep1, "energylep1/D");
    ...
    ExTree->Branch("j1metPhi_new_f",&j1metPhi_new_f, "j1metPhi_new_f/D");
    ExTree->Branch("j1metPhi_JEC_up_f",&j1metPhi_JEC_up_f, "j1metPhi_JEC_up_f/D");
    ExTree->Branch("j1metPhi_JEC_down_f",&j1metPhi_JEC_down_f, "j1metPhi_JEC_down_f/D");
    ExTree->Branch("j1metPhi_JER_up_f",&j1metPhi_JER_up_f, "j1metPhi_JER_up_f/D");
    ExTree->Branch("j1metPhi_JER_down_f",&j1metPhi_JER_down_f, "j1metPhi_JER_down_f/D");
    ...
    ExTree->Branch("j2metPhi_new_f",&j2metPhi_new_f, "j2metPhi_new_f/D");
    ExTree->Branch("j2metPhi_JEC_up_f",&j2metPhi_JEC_up_f, "j2metPhi_JEC_up_f/D");
    ExTree->Branch("j2metPhi_JEC_down_f",&j2metPhi_JEC_down_f, "j2metPhi_JEC_down_f/D");
    ExTree->Branch("j2metPhi_JER_up_f",&j2metPhi_JER_up_f, "j2metPhi_JER_up_f/D");
    ExTree->Branch("j2metPhi_JER_down_f",&j2metPhi_JER_down_f, "j2metPhi_JER_down_f/D");
